...
Die durchschnittliche Frame Rate des Unity-Clients wurde sowohl im Baseline-Betrieb ohne aktive Rekonstruktion als auch während der Rekonstruktions- und Visualisierungsphase gemessen (Abbildung~\ref{frame_rate}). Da sich die GPU-/CPU-Auslastung auf der Meta Quest 3 im laufenden Betrieb nur eingeschränkt messen lies, wird die Performance hier ausschließlich über die FPS ausgewertet. Im Baseline-Betrieb erreicht der Client eine durchschnittliche Bildrate von 72\,fps.  
