...
\begin{table}[h]
    ...
    \begin{tabular}{llcccc}
        \toprule
        \textbf{Szene} & \textbf{Modell} & \makecell{\textbf{Ø Fragment-} \\ \textbf{größe [MB]}} & \makecell{\textbf{Ø Ergebnis-} \\ \textbf{größe [MB]}} & \makecell{\textbf{Upload} \\ \textbf{[Mbps]}} & \makecell{\textbf{Download} \\ \textbf{[Mbps]}} \\
        \midrule
        \multirow{4}{*}{V1} 
