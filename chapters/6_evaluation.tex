...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lcccX}
        ...
        R2 & $6\times 5\times 3$ & [200] & [50] & \textit{Wohnzimmer}, Glas, Reflexionen, große homogene Flächen \\
        \bottomrule
    \end{tabularx}
...
Um einen fairen und direkten Vergleich zwischen den verschiedenen Rekonstruktionsmodellen zu ermöglichen, wurden für alle Modelle \textbf{einheitliche Aufnahmeparameter} verwendet. Diese Designentscheidung stellt sicher, dass beobachtete Unterschiede in Performance und Rekonstruktionsqualität ausschließlich auf die Modellarchitektur und nicht auf unterschiedliche Eingabebedingungen zurückzuführen sind
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lX}
        ...
        \midrule
        Fenstergröße (Frames pro Fragment) & [15] \\
        Bildauflösung & 640 × 480 Pixel \\
        Bildformat & RGB (3 Kanäle, 8-bit) \\
        \midrule
        Kamerabewegung & Langsam, kontinuierlich (ca. 0.2 m/s) \\
        Rotationsgeschwindigkeit & Max. 30°/s \\
        Intrinsiken-Quelle & Unity XR-Subsystem (automatisch) \\
        Extrinsiken-Quelle & Unity XR-Subsystem (6DoF-Tracking) \\
        \midrule
        Wiederholungen pro Szene & [3] Takes (für Stabilitätsbewertung) \\
        \bottomrule
    \end{tabularx}
    \caption{Einheitliche Aufnahmeparameter für alle Modelle}
\end{table}

\noindent
Die Wahl einheitlicher Parameter über alle Modelle hinweg dient der \textbf{Vergleichbarkeit} und \textbf{wissenschaftlichen Fairness} der Evaluation. Unterschiedliche Modellarchitekturen -- volumetrische Verfahren (NeuralRecon, VisFusion) und SLAM-basierte Ansätze (MASt3R-SLAM, SLAM3R) -- weisen zwar unterschiedliche optimale Fenstergößen auf, jedoch würde eine modellspezifische Anpassung die direkte Vergleichbarkeit der Ergebnisse erschweren. Die gewählte Fenstergröße von [15] Frames stellt einen Kompromiss dar, der für alle Modelle verarbeitbar ist.

\medskip
\noindent
Es ist zu erwarten, dass durch \textbf{modellspezifisches Tuning} der Aufnahmeparameter, insbesondere der Fenstergröße, für jedes Modell individuell bessere Rekonstruktionsergebnisse erzielt werden könnten. Volumetrische Verfahren profitieren beispielsweise von kleineren Fenstern (typisch 9 Frames), während SLAM-basierte Ansätze größere Kontexte (15-20 Frames) bevorzugen. Die in dieser Arbeit gemessenen Performance-Werte und Qualitätsmetriken repräsentieren daher die Leistungsfähigkeit der Modelle unter standardisierten, aber nicht notwendigerweise optimalen Bedingungen.
