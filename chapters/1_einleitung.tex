...
In den letzten Jahren wurden daher vermehrt Verfahren entwickelt, die fortlaufende RGB-Videodaten nutzen, um die Geometrie einer Szene schrittweise zu rekonstruieren. \needcitation Monokulare Verfahren spielen im Kontext von VR dabei eine besonders zentrale Rolle. Im Gegensatz zu Tiefensensoren oder Mehrkamera-Setups benötigen sie keine zusätzliche Hardware und können direkt auf die Frontkameras moderner VR-Headsets zurückgreifen, die typischerweise genau solche kontinuierlichen RGB-Bildströme liefern. 

Obwohl monokulare Rekonstruktionsverfahren grundsätzlich gut zu den Sensoren moderner VR-Headsets passen, ist ihre praktische Einbindung in bestehende Anwendungen bislang kaum etabliert. Viele aktuelle Modelle werden in isolierten Forschungskontexten entwickelt und bringen eigene Laufzeitumgebungen, Frameworks und Datenpipelines mit, die selten auf den Einsatz in interaktiven Systemen ausgelegt sind. \needcitation VR-Anwendungen benötigen jedoch einen stabilen und klar strukturierten Datenfluss, der kontinuierlich wachsende Modelle verlässlich bereitstellt und eine nahtlose Integration in das Frontend ermöglicht. Eine modulare Architektur, die verschiedene Rekonstruktionsverfahren kapselt, vereinheitlicht und für VR-Umgebungen nutzbar macht, ist in der Forschung bislang nur unzureichend adressiert. An dieser Stelle setzt die vorliegende Arbeit an.
