\addchap*{\centering Zusammenfassung}
...
Mithilfe einer experimentellen Evaluation werden anschließend die Funktionalität, das Laufzeitverhalten, die Stabilität und die Rekonstruktionsqualität in mehreren Szenarien untersucht.
\end{singlespace}
